const translations = {
	de: {
		...
		about: {
			...
			title: "ÜBER RAYVEN",
			lead: "Rayven ist das eSports-Team der Technischen Hochschule Augsburg (TH Augsburg) – ein Kollektiv aus Studierenden, die sich einer Idee verschrieben haben: Präsenz zeigen, ohne laut sein zu müssen.",
	...
	en: {
		...
		about: {
			...
			eyebrow: "WHO WE ARE",
			title: "ABOUT RAYVEN",
			lead: "Rayven is the esports team of the Technical University of Applied Sciences Augsburg (TH Augsburg) – a collective of students devoted to one idea: showing presence without needing to shout.",
